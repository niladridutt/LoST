...
class D3D_DiT(nn.Module):
    ...
    def forward(
        ...
        # print("pixel_hidden_states", pixel_hidden_states.shape)

        # print("encoder_hidden_states_first_token", encoder_hidden_states[:, 0].shape)
        ...
        # print("hidden_states4", hidden_states.shape)
        hidden_states = torch.einsum("nhwpqc->nchpwq", hidden_states)
        # print("hidden_states5", hidden_states.shape)
